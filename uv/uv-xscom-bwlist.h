...
#ifndef __UV_XSCOM_BWLIST_H
#define __UV_XSCOM_BWLIST_H
...
#define  GREYLIST_TABLE1_MASK 0xFFFFFFFF
   ...
   /*@brief Format of T1 table date */
    ...
    // const size_t SEC_LIST_TABLE_HDR_SIZE = sizeof(sec_header_dump_t);

     /* @brief _is_present_addr    - Look up tables to find if the given
     *                          address ii present
