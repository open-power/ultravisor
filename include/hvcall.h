...
struct stack_frame;
extern int syscall_hypercall(uint64_t function, struct stack_frame *stack);
extern void get_n_hcall_regs(uint64_t hcall, int16_t *n_in, int16_t *n_out);
extern void init_hcall_regs_map(void);
#endif /* __ASSEMBLY__ */
